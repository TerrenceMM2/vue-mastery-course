          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                <!-- :style = Vue shorthand; same as inline styling -->
                <div
                  class="color-line"
              ...
              <div class="field">
                <label for="power">
                  ...
                  <div class="select is-primary">
                    <!-- Drop down ties to hero.power data model, has a class binding, and a key event -->
                    <select
                      id="power"
                      v-model="hero.power"
